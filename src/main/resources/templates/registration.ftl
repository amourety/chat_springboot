...
<div class="container">
    <div class="main">
        <div class="maincentre">
            <form class="form-signin" role="form" method="post" action="registration" style="min-width: 300px;
    max-width: 300px;padding-top: 50px;">
                <h2 class="form-signin-heading" style="font-family: 'Courier New';">Registration</h2>
                <input id="username" name="username" type="text" class="form-control" placeholder="Login" required=""
                       autofocus="" style="margin-bottom: 3px">
